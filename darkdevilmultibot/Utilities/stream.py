...
from darkdevilmultibot import BOT_USERNAME, db_mem
from darkdevilmultibot.Core.PyTgCalls import Queues
from darkdevilmultibot.Core.PyTgCalls.darkdevilmultibot import join_stream
from darkdevilmultibot.Database import (add_active_chat, is_active_chat, music_off,
                            music_on)
from darkdevilmultibot.Inline import (audio_markup, audio_markup2, primary_markup,
                          secondary_markup)
