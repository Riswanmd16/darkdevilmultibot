...
from darkdevilmultibot import (BOT_USERNAME, DURATION_LIMIT, DURATION_LIMIT_MIN,
...
from darkdevilmultibot.Decorators.assistant import AssistantAdd
from darkdevilmultibot.Decorators.checker import checker
from darkdevilmultibot.Decorators.permission import PermissionCheck
from darkdevilmultibot.Inline import (playlist_markup, search_markup, search_markup2,
                          url_markup, url_markup2)
from darkdevilmultibot.Utilities.changers import seconds_to_min, time_to_seconds
from darkdevilmultibot.Utilities.chat import specialfont_to_normal
from darkdevilmultibot.Utilities.stream import start_stream, start_stream_audio
from darkdevilmultibot.Utilities.theme import check_theme
from darkdevilmultibot.Utilities.thumbnails import gen_thumb
from darkdevilmultibot.Utilities.url import get_url
from darkdevilmultibot.Utilities.youtube import (get_yt_info_id, get_yt_info_query,
...
@app.on_callback_query(filters.regex(pattern=r"darkdevilmultibot"))
