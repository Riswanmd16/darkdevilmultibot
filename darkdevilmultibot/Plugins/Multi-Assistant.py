...
from darkdevilmultibot import SUDOERS, app
from darkdevilmultibot.Database import get_assistant, save_assistant
...
async def assis_change(_, message: Message):
    ...
    if not _assistant:
        await message.reply_text(
            f"**__darkdevilmultibot Music Bot Assistant Alloted__**\n\nAssistant No. **{ran_ass}**"
        )
        assis = {
