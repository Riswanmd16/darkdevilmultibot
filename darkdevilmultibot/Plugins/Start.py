...
from darkdevilmultibot import ASSIDS, BOT_ID, MUSIC_BOT_NAME, OWNER_ID, SUDOERS, app
from darkdevilmultibot import boottime as bot_start_time
from darkdevilmultibot import db
from darkdevilmultibot.Core.PyTgCalls import darkdevilmultibot
from darkdevilmultibot.Database import (add_nonadmin_chat, add_served_chat,
...
from darkdevilmultibot.Decorators.admins import ActualAdminCB
from darkdevilmultibot.Decorators.permission import PermissionCheck
from darkdevilmultibot.Inline import (custommarkup, dashmarkup, setting_markup,
                          setting_markup2, start_pannel, usermarkup,
                          volmarkup)
from darkdevilmultibot.Utilities.assistant import get_assistant_details, random_assistant
from darkdevilmultibot.Utilities.ping import get_readable_time
...
async def start_markup_check(_, CallbackQuery):
    ...
    if command == "LV":
        ...
        volume = 25
        try:
            await darkdevilmultibot.pytgcalls.change_volume_call(c_id, volume)
    ...
    if command == "DIT":
        ...
        await CallbackQuery.answer(
            f"darkdevilmultibot Disk Usage: {diske}%", show_alert=True
        )
