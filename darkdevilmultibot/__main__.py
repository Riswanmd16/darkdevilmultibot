...
from darkdevilmultibot import (ASS_CLI_1, ASS_CLI_2, ASS_CLI_3, ASS_CLI_4, ASS_CLI_5,
                   ASSID1, ASSID2, ASSID3, ASSID4, ASSID5, ASSNAME1, ASSNAME2,
                   ASSNAME3, ASSNAME4, ASSNAME5, BOT_ID, BOT_NAME, app)
from darkdevilmultibot.Core.Logger.Log import (startup_delete_last, startup_edit_last,
                                   startup_send_new)
from darkdevilmultibot.Core.PyTgCalls.darkdevilmultibot import (pytgcalls1, pytgcalls2, pytgcalls3,
                                        pytgcalls4, pytgcalls5)
from darkdevilmultibot.Database import get_active_chats, get_sudoers, remove_active_chat
from darkdevilmultibot.Inline import private_panel
from darkdevilmultibot.Plugins import ALL_MODULES
from darkdevilmultibot.Utilities.inline import paginate_modules
...
async def initiate_bot():
    with console.status(
        "[magenta] Booting up The darkdevilmultibot Music Bot...",
    ) as status:
        ...
        for all_module in ALL_MODULES:
            imported_module = importlib.import_module(
                "darkdevilmultibot.Plugins." + all_module
            )
            if (
    ...
    console.print(
        "[bold green]Congrats!! darkdevilmultibot Music Bot has started successfully!\n"
    )
    try:
    ...
    try:
        ...
        return
    try:
        await ASS_CLI_1.join_chat("Officialdarkdevilmultibot")
    except:
        pass
    try:
        ...
        return
    try:
        await ASS_CLI_2.join_chat("Officialdarkdevilmultibot")
    except:
        pass
    try:
        ...
        return
    try:
        await ASS_CLI_3.join_chat("Officialdarkdevilmultibot")
    except:
        pass
    try:
        ...
        return
    try:
        await ASS_CLI_4.join_chat("Officialdarkdevilmultibot")
    except:
        pass
    try:
        ...
        return
    try:
        await ASS_CLI_5.join_chat("Officialdarkdevilmultibot")
    except:
        pass
