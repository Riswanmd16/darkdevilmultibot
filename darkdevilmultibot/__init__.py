...
from darkdevilmultibot.Core.Clients.cli import (ASS_CLI_1, ASS_CLI_2, ASS_CLI_3,
...
db = MONGODB_CLI.darkdevilmultibot
...
async def initiate_bot():
    ...
    with console.status(
        ...
        initial = await startup_send_new("Starting darkdevilmultibot Music Bot...")
        await asyncio.sleep(0.5)
